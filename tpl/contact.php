...
<!-- Mirrored from swin-themes.com/html/fooday/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Jul 2017 16:00:44 GMT -->
<head>
    <meta charset="UTF-8">
                        ...
                        <nav id="main-nav-offcanvas" class="main-nav-wrapper">
                            ...
                            <div class="main-nav">
                                <ul id="main-nav" class="nav nav-pills">
                                    ...
                                    <li class="dropdown current-menu-item"><a href="contact.php">تماس با ما</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
          ...
          <div data-bottom-top="background-position: 50% 50px;" data-center="background-position: 50% 0px;" data-top-bottom="background-position: 50% -50px;" class="page-title page-contact">
            <div class="container">
              <div class="title-wrapper">
                <div data-top="transform: translateY(0px);opacity:1;" data--120-top="transform: translateY(-30px);opacity:0;" data-anchor-target=".page-title" class="title">تماس با ما</div>
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-8 col-sm-12">
                  <div class="swin-sc swin-sc-title style-2 text-right">
                    <p class="title"><span>نظرات خود را برای ما ارسال کنید</span></p>
                  </div>
                      ...
                      <form>
                        ...
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <input type="text" placeholder="ایمیل" class="form-control">
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="input-group">
                            ...
                            <input type="text" placeholder="تلفن تماس" class="form-control">
                          </div>
                        </div>
                        <div class="form-group">
                          <textarea placeholder="پیام" class="form-control"></textarea>
                        </div>
                        <div class="form-group">
                          <div class="swin-btn-wrap"><a href="#" class="swin-btn center form-submit"><span>ارسال</span></a></div>
                        </div>
                      </form>
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                  <div class="swin-sc swin-sc-title style-2 text-right">
                    <p class="title"><span>اطلاعات تماس</span></p>
                  </div>
                  <div class="swin-sc swin-sc-contact">
                    ...
                    <div class="media item">
                      <div class="media-body">
                        <h4 class="media-heading title">نیشابور</h4>
                        <div class="description">شهرک صنعتی خیام</div>
                      </div>
                    </div>
                    <div class="media item">
                      <div class="media-left">
                      ...
                      <div class="media-body">
                        <h4 class="media-heading title">شماره تماس</h4>
                        <div class="description">(051) 5555</div>
                      </div>
                    </div>
                    <div class="media item">
                      <div class="media-left">
                      ...
                      <div class="media-body">
                        <h4 class="media-heading title">ایمیل</h4>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-lg-offset-2">
                                    <div class="subscribe-heading">
                                        ...
                                        <div class="des">هر روز آخرین اخبار و جدیدترین غداهارو برای شما میفرستیم</div>
                                    </div>
                                ...
                                <div class="ft-widget-area">
                                    <div class="ft-area1">
                                        <div class="swin-wget swin-wget-about">
                                            <div class="clearfix">
                                                <a class="wget-logo"><img alt="" class="img img-responsive"></a>
                                            ...
                                            <div class="about-contact-info clearfix">
                                                <div class="address-info">
                                                    ...
                                                    <div class="info-content">
                                                        ...
                                                        <!--<p>اصفهان خیابان مطهری نرسیده پمپ بنزین</p>-->
                                                    </div>
                                                </div>
                                ...
                                <div class="ft-fixed-area wow fadeInRight">
                                    <div class="reservation-box">
                                        <div class="reservation-wrap">
                                            ...
                                            <h3 class="res-title">تلفن فروش</h3>
