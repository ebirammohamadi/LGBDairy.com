...
<div class="wrapper">
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?= $selectUser->firstname . " " . $selectUser->lastname?></h3>

                <p class="text-muted text-center">شماره تماس</p>
                <strong><i class="fa fa-map-marker mr-1"></i> شهر</strong>

                <p class="text-muted"><?=  $selectUser->address?></p>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card card-primary">
              ...
              <form action= "" method="POST">
                <div class="card-body">
                  <strong><i class="fa fa-book mr-1">محصولات</i></strong>
                  ...
                  <label>درصد تخفیف</label>
                    ...
                    <input type="text" name="userid" value="<?=$selectUser->id ?>" hidden>
                      <span class="username">
                        <button type="ssubmit" name="submit">تایید</button>
                      </span>
                  </p>
                  <hr>
                  </p>
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">تخفیفات فعال شده برای مشتری</a></li>
                  ...
                  <div class="active tab-pane" id="activity">
                    ...
                    <div class="post">
                      <div class="user-block">
                        <span class="username">
                          <a href="">شماره محصول</a>
                          <a href=""><?= $discount->productid?></a>
                        </span>
                        <span>درصد تخفیف</span>
                        <span class="description"><?= $discount->discount?></span>
                        <td>
                            <?php   if($discount->active == 1){ ?>
                                <div class="row">
                                    <div class="col-md-3">
                                        <form action='' method='POST'>
                                            <button type='submit' name              ='btnActive' class='btn btn-block       btn-outline-success btn-sm' value       =<?= $discount->id ?>>فعال</button>
                                        </form>
                                    </div>
                                    <div class="col-md-3">
                                        <a href='?num=<?=$_GET['num'];?>&&deletediscount=<?= $discount->id ?>'><button type='button' class='btn btn-block btn-outline-danger btn-sm'>حذف</button></a>
                                    </div>
                                </div>                
                            <?php } else if($discount->active == 0){ ?>
                                <div class="row">
                                    <div class="col-md-3">
                                        <form action='' method='POST'>
                                            <button type='submit' name              ='btnActive' class='btn btn-block       btn-outline-danger btn-sm' value       =<?= $discount->id ?>>غیر فعال</button>
                                        </form>
                                    </div>
                                    <div class="col-md-3">
                                        <a href='?num=<?=$_GET['num'];?>&&deleteddiscount=<?= $discount->id ?>'><button type='button' class='btn btn-block btn-outline-danger btn-sm'>حذف</button></a>
                                    </div>
                                </div>
  ...
  <footer class="main-footer">
    <strong>CopyLeft &copy; 2020 <a href="">لبن گستر بینالود</a>.</strong>
  </footer>
