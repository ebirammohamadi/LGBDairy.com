            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <h3 class="card-title">مدیریت پیام های ارسالی</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php
                                foreach ($selectContactForms as $selectContactForm){ 
                                echo "<tr>
                                                <td>$selectContactForm->name</td>
                                                <td> $selectContactForm->message </td> 
                                                <td> $selectContactForm->email </td> 
                                                <td> $selectContactForm->phone </td> 
                                                <td> $selectContactForm->date </td> 
                                                
                                                ";
                                                if (isset($_SESSION['superadmin'])) {
                                                    if ($selectContactForm->answer == 1) {
                                                        echo "<td><span class='btn btn-block btn-outline-success btn-sm' >پاسخ داده شده</span></td>";
                                                    } else {
                                                        echo "
                                                        <td><a href='answer-contactRequest.php?userid=$selectContactForm->id'><button type='button' class='btn btn-block btn-outline-primary btn-sm'>ارسال پاسخ</button></a></td>
                                                        ";
                                                    }
                                                    echo " 
                                                    <td>
                                                    <a href='?deletecomment=$selectContactForm->id'><button type='button' class='btn btn-block btn-outline-danger btn-sm'>حذف</button></a>
                                                    </td> 
                                                </tr>";
                                                }else{
                                                  echo " <td><button type='button' class='btn btn-block btn-outline-primary btn-disabled btn-sm'>ارسال پاسخ</button></td>
                                                    <td>
                                                        <button type='button' class='btn btn-block btn-outline-danger btn-disabled btn-sm'>حذف</button>
                                                    </td>
                                                    </tr>";
                                                }
                            } ?>
