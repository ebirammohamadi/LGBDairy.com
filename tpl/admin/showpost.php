                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php
                                foreach ($selectPostAll as $selectPostAlls){
                                    $i = 1;
                                    echo "
                                        <tr> 
                                            <td>". $i  ."</td>
                                            <td>". selectPostType($selectPostAlls->type) ."</td>
                                            <td>" . $selectPostAlls->subject ."</td> 
                                            <td>" . wordwrap($selectPostAlls->text, 80, "\n", true) ."</td>
                                            <td><img src='$selectPostAlls->pic' style='width:160px;height:140px'></td> 
                                            <td>" . $selectPostAlls->date ."</td> 
                                            <td>";
                                                if($selectPostAlls->active == 1){
                                                echo"
                                                    <form action='' method='POST'>
                                                    <button type='submit' class='btn btn-block btn-outline-success btn-sm' name='numActive' value='$selectPostAlls->id'>فعال</button>
                                                    </form>
                                            ";
                                            }else if($selectPostAlls->active == 0){ echo "
                                            <form action='' method='POST'>
                                            <button type='submit' class='btn btn-block btn-outline-danger btn-sm' name='numActive' value='$selectPostAlls->id'>غیر فعال</button>
                                            </form>
                                            ";}
                                            echo "
                                            ...
                                            <td>
                                            <a href='?deletepost=$selectPostAlls->id'><button type='button' class='btn btn-block btn-outline-danger btn-sm'>حذف</button></a>
                                            <br/>
                                            <a href='updatePost.php?updatepost=$selectPostAlls->id&type=$selectPostAlls->type&fildid=$selectPostAlls->fild'><button type='button' class='btn btn-block btn-outline-success btn-sm'>بروزرسانی</button></a>
                                            </td>
                                        </tr>";
                                }?>
