    ...
    <body class="hold-transition sidebar-mini">
        <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                <!-- Brand Logo -->
                <a href=<?= BASE_URL ."user.php"?> class="brand-link">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <?php
                                        ...
                                        <form action='?submit' method='POST'>
                                            <tr>
                                                <td style='width:160px;height           :140px'><input name='name' value='$order->name' style='border:none' readonly ></td>
                                            <td style='width:160px;height:140px'         ><input name='weight' value='$order->weight گرم' style='border:none' readonly ></td>      
                                            <td style='width:160px;height               :140px'><input name='price' value='" .number_format($order->price) . "' style='border:none' readonly></td>
                                            <td><input name='discount' value='$discount->discount ' style='border:none' readonly ></td>
                                            <td>تعداد را وارد نمایید<input name='total' style='width: 30%'></td        >
                                            <td>
                                                <button type='submit' class            ='btn btn-block btn-outline             -primary btn-sm' name='submit'>سفارش</button>
                                            </td>
                                            </tr>
                                        </form>    
                                            ";
