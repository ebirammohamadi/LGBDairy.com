                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <?php
                                            foreach ($selectOrders as $selectOrder){
                                            ...
                                            echo "<tr>
                                                            ...
                                                            <td> $productCode با قیمت  $productPrice  </td> 
                                                            <td>  $selectOrder->date </td> 
                                                            <td>";
                                                            ...
                                                            <span>دانلود نشده</span>
                                                        ";}
                                                        echo "   
                                                            </td>
                                                            <td>
                                                            <a href='invoice-show.php?deletecomment=$selectOrder->id'><button type='button' class='btn btn-block btn-outline-primary btn-sm'>نمایش</button></a>
                                                            </td>
                                                            <td>
