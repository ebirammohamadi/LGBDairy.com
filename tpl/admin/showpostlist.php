                                    ...
                                    foreach ($selectPostLists as $selectPostList){
                                        ...
                                        echo "
                                            <tr>      
                                                ...
                                                <td>$selectPostList->date</td>  
                                                <td>"; 
                                                if($selectPostList->active == 1){
                                                    echo"
                                                    <form action='' method='POST'>
                                                    <button type='submit' class='btn btn-block btn-outline-success btn-sm' name='numActive' value='$selectPostList->id'>فعال</button>
                                                    </form>
                                                ";
                                                }else if($selectPostList->active == 0){ echo "
                                                <form action='' method='POST'>
                                                <button type='submit' class='btn btn-block btn-outline-danger btn-sm' name='numActive' value='$selectPostList->id'>غیر فعال</button>
                                                </form>
                                                ";}
                                                echo "
                                                </td> 
                                                <td>
                                                <a href='?deleteproduct=$selectPostList->id'><button type='button' class='btn btn-block btn-outline-danger btn-sm'>حذف</button></a>
                                                <br/>
                                                <a href='postProduct.php?updateproduct=$selectPostList->id'><button type='button' class='btn btn-block btn-outline-success btn-sm'>بروزرسانی</button></a>
                                                </td>
                                            </tr>";
                                            ;       
                                                    }?>
