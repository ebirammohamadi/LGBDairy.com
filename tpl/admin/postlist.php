                ...
                <div class="row">
                    ...
                    <div class="card">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php
                                foreach ($isUniques as $isunique){ 
                                echo "<tr><td>$isunique->code</td>
                                    <td>$isunique->name</td> 
                                    <td>$isunique->price</td> 
                                    <td>$isunique->date</td> 
                                    <td></td>
                                    <td>";
                                    if($isunique->active == 1){
                                        echo"
                                        <form action='?action=numActive' method='POST'>
                                        <button type='submit' class='btn btn-block btn-outline-success btn-sm' name='btnActive' value='$isunique->id'>فعال</button>
                                        </form>
                                    ";
                                    }else if($isunique->active == 0){ echo "
                                    <form action='?action=numActive' method='POST'>
                                    <button type='submit' class='btn btn-block btn-outline-danger btn-sm' name='btnActive' value='$isunique->id'>غیر فعال</button>
                                    </form>
                                    ";}
