                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <?php
                                            ...
                                            echo "<tr><td>$selectuser->firstname
                                                ...
                                                <td>";
                                                if($selectuser->active == 1){
                                                    echo"
                                                    <form action='?action=numActive' method='POST'>
                                                    <button type='submit' class='btn btn-block btn-outline-success btn-sm' name='numActive' value='$selectuser->id'>فعال</button>
                                                    </form>
                                                ";
                                                }else if($selectuser->active == 0){ echo "
                                                <form action='?action=numActive' method='POST'>
                                                <button type='submit' class='btn btn-block btn-outline-danger btn-sm' name='numActive' value='$selectuser->id'>غیر فعال</button>
                                                </form>
                                                ";}
                                            ...
                                            <td>
                                            <a href='?deleteuser=$selectuser->id'><button type='button' class='btn btn-block btn-outline-danger btn-sm'>حذف</button></a>
                                            <br/>
                                            <a href='register.php?updateuser=$selectuser->id'><button type='button' class='btn btn-block btn-outline-success btn-sm'>بروزرسانی</button></a>
                                            </td>
                                            <td><a href= " . BASE_URL . "profile.php?num=$selectuser->id class='nav-link'><button type='button' class='btn btn-block btn-outline-primary btn-sm'>پروفایل</button></a></td>
                                            </tr>
                                        ";  } ?>
                                        </tbody>
                                    </table>
