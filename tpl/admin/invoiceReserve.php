                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <?php
                                            foreach ($selectReservations as $selectReservation){
                                                // $array = json_decode($selectOrder->basket,true);
                                                // $productCode = selectProductByCode($array['code'])->name;
                                                // $productPrice = $array['price'];
                                            echo "<tr>";
                                            if($selectReservation->userid == NULL ){ $username = "میهمان" ; echo "<td>$username </td>";}else{
                                                $username = selectUserByUserId($selectReservation->userid);
                                                echo  " <td> $username->firstname  $username->lastname </td>";
                                            }
                                                     echo "       
                                                            <td>$selectReservation->id </td> 
                                                            <td>  $selectReservation->date </td> 
                                                            <td>
                                                        ";
                                                        if(isset($_SESSION['superadmin'])){
                                                            echo "
                                                            <a href='?deleteorder=$selectReservation->id'><button type='button' class='btn btn-block btn-outline-danger btn-sm'>حذف</button></a>
                                                            ";
                                                        }else{
                                                            echo "
                                                            <a ><button type='button' class='btn btn-block btn-outline-danger btn-sm disabled'>حذف</button></a>
                                                            ";
                                                        }
                                                        "
                                                            </td> 
