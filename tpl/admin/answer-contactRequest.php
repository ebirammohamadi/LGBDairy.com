...
<html>
    <head>
        ...
        <title>مدیریت تماس با ما مشاوره</title>
                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                <?php
                                if(isset($_GET['action']) && $_GET['action'] == 'answerAdvice'){echo "<tr></tr>"; }
                                else{
                                    echo "<tr>
                                                    <td> $selectAdviceForm->name </td>
                                                    <td> $selectAdviceForm->subject </td>
                                                    <td> $selectAdviceForm->email </td> 
                                                    <td> $selectAdviceForm->phone </td> 
                                                    <td> $selectAdviceForm->date </td>
                                                </tr>";
                                }  ?>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                <tbody>
                                <div class="mb-3">
                                    <label style="color:red"> متن پاسخ :</label>
                                    <?php if(isset($_GET['action']) && $_GET['action'] == 'answerAdvice'){echo "<form></form>"; }else{?>
                                    <form action="?action=answerAdvice&id=<?=$selectAdviceForm->id?>" method="POST">
                                        <input name="email" value="<?=$selectAdviceForm->email?>" hidden >
                                        <input name="phone" value="<?=$selectAdviceForm->phone?>" hidden >
                                        <input name="userid" value="<?=$selectAdviceForm->userid?>" hidden >
                                    <textarea class="textarea" name="text" placeholder="پاسخ را وارد نمایید" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                    <input name="type" value="2" hidden>
                                </div>
                                <div class="card-footer">
                                    <button type="submit" name="sendAnswerContact" class="btn btn-primary">ارسال</button>
                                </div>
                                </form>
                                <?php }?>
                                </tbody>
