                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <a href="" class="nav-link">
                                <?php
                                    foreach ($selectPostProductAlls as $selectPostProductAll){
                                        
                                        echo "
                                            <tr>      
                                                <td>$selectPostProductAll->code</td>
                                                <td>$selectPostProductAll->name</td> 
                                                <td>".number_format($selectPostProductAll->price) ."</td> 
                                                <td>$selectPostProductAll->weight</td> 
                                                <td><img src='$selectPostProductAll->pic' style='width:160px;height:140px'></td> 
                                                <td>"; 
                                                if($selectPostProductAll->active == 1){
                                                    echo"
                                                    <form action='' method='POST'>
                                                    <button type='submit' class='btn btn-block btn-outline-success btn-sm' name='numActive' value='$selectPostProductAll->id'>فعال</button>
                                                    </form>
                                                ";
                                                }else if($selectPostProductAll->active == 0){ echo "
                                                <form action='' method='POST'>
                                                <button type='submit' class='btn btn-block btn-outline-danger btn-sm' name='numActive' value='$selectPostProductAll->id'>غیر فعال</button>
                                                </form>
                                                ";}
                                                echo "
                                                </td> 
                                                <td>
                                                <a href='?page=1&&deleteproduct=$selectPostProductAll->id'><button type='button' class='btn btn-block btn-outline-danger btn-sm'>حذف</button></a>
                                                <br/>
                                                <a href='postproduct.php?updateproduct=$selectPostProductAll->id'><button type='button' class='btn btn-block btn-outline-success btn-sm'>بروزرسانی</button></a>
                                                </td>
                                            </tr>";
                                            ;       
                                                    }?>
